...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission (MainActivity.this,
            ...
            heading.setText("सुraksha needs access to");
            ...
            declaratioText.setText("The app is solely developed by SRM Developers and all data related to this app is stored locally in your phone.");
        ...
        shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               try {
                    ...
                    shareIntent.putExtra(Intent.EXTRA_SUBJECT, "सुraksha");
                    String shareMessage= "Hey Ladies,I am gifting a token of safety to all the females in my society as \n\n*सुraksha* solves a very heart wrenching problem of our civilisation, *Women's Safety*. \n\nJust *download*,start using, and spread the app \n\nSo that any *female* related to you can feel safer and empowered in this world. \n\nDownload सुraksha at:-\n";

                    shareMessage = shareMessage + "https://play.google.com/store/apps/details/" ;
